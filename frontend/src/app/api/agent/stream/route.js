...
export async function POST(request) {
  try {
    ...
    console.log('Sending stream to backend with access token:', 
                googleAccessToken ? `${googleAccessToken.substring(0, 10)}...` : 'None');
...
// This route needs to handle GET requests for SSE connection
